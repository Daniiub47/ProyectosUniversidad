...
// PTC_R2
wire [31:0] wb_m2s_ptcR2_adr;
wire [31:0] wb_m2s_ptcR2_dat;
wire  [3:0] wb_m2s_ptcR2_sel;
wire        wb_m2s_ptcR2_we;
wire        wb_m2s_ptcR2_cyc;
wire        wb_m2s_ptcR2_stb;
wire  [2:0] wb_m2s_ptcR2_cti;
wire  [1:0] wb_m2s_ptcR2_bte;
wire [31:0] wb_s2m_ptcR2_dat;
wire        wb_s2m_ptcR2_ack;
wire        wb_s2m_ptcR2_err;
wire        wb_s2m_ptcR2_rty;

// PTC_G2
wire [31:0] wb_m2s_ptcG2_adr;
wire [31:0] wb_m2s_ptcG2_dat;
wire  [3:0] wb_m2s_ptcG2_sel;
wire        wb_m2s_ptcG2_we;
wire        wb_m2s_ptcG2_cyc;
wire        wb_m2s_ptcG2_stb;
wire  [2:0] wb_m2s_ptcG2_cti;
wire  [1:0] wb_m2s_ptcG2_bte;
wire [31:0] wb_s2m_ptcG2_dat;
wire        wb_s2m_ptcG2_ack;
wire        wb_s2m_ptcG2_err;
wire        wb_s2m_ptcG2_rty;

// PTC_B2
wire [31:0] wb_m2s_ptcB2_adr;
wire [31:0] wb_m2s_ptcB2_dat;
wire  [3:0] wb_m2s_ptcB2_sel;
wire        wb_m2s_ptcB2_we;
wire        wb_m2s_ptcB2_cyc;
wire        wb_m2s_ptcB2_stb;
wire  [2:0] wb_m2s_ptcB2_cti;
wire  [1:0] wb_m2s_ptcB2_bte;
wire [31:0] wb_s2m_ptcB2_dat;
wire        wb_s2m_ptcB2_ack;
wire        wb_s2m_ptcB2_err;
wire        wb_s2m_ptcB2_rty;
...
// PTC_R2
    .wb_ptcR2_adr_o      (wb_m2s_ptcR2_adr),
    .wb_ptcR2_dat_o      (wb_m2s_ptcR2_dat),
    .wb_ptcR2_sel_o      (wb_m2s_ptcR2_sel),
    .wb_ptcR2_we_o       (wb_m2s_ptcR2_we),
    .wb_ptcR2_cyc_o      (wb_m2s_ptcR2_cyc),
    .wb_ptcR2_stb_o      (wb_m2s_ptcR2_stb),
    .wb_ptcR2_cti_o      (wb_m2s_ptcR2_cti),
    .wb_ptcR2_bte_o      (wb_m2s_ptcR2_bte),
    .wb_ptcR2_dat_i      (wb_s2m_ptcR2_dat),
    .wb_ptcR2_ack_i      (wb_s2m_ptcR2_ack),
    .wb_ptcR2_err_i      (wb_s2m_ptcR2_err),
    .wb_ptcR2_rty_i      (wb_s2m_ptcR2_rty),

// PTC_G2
    .wb_ptcG2_adr_o      (wb_m2s_ptcG2_adr),
    .wb_ptcG2_dat_o      (wb_m2s_ptcG2_dat),
    .wb_ptcG2_sel_o      (wb_m2s_ptcG2_sel),
    .wb_ptcG2_we_o       (wb_m2s_ptcG2_we),
    .wb_ptcG2_cyc_o      (wb_m2s_ptcG2_cyc),
    .wb_ptcG2_stb_o      (wb_m2s_ptcG2_stb),
    .wb_ptcG2_cti_o      (wb_m2s_ptcG2_cti),
    .wb_ptcG2_bte_o      (wb_m2s_ptcG2_bte),
    .wb_ptcG2_dat_i      (wb_s2m_ptcG2_dat),
    .wb_ptcG2_ack_i      (wb_s2m_ptcG2_ack),
    .wb_ptcG2_err_i      (wb_s2m_ptcG2_err),
    .wb_ptcG2_rty_i      (wb_s2m_ptcG2_rty),

// PTC_B2
    .wb_ptcB2_adr_o      (wb_m2s_ptcB2_adr),
    .wb_ptcB2_dat_o      (wb_m2s_ptcB2_dat),
    .wb_ptcB2_sel_o      (wb_m2s_ptcB2_sel),
    .wb_ptcB2_we_o       (wb_m2s_ptcB2_we),
    .wb_ptcB2_cyc_o      (wb_m2s_ptcB2_cyc),
    .wb_ptcB2_stb_o      (wb_m2s_ptcB2_stb),
    .wb_ptcB2_cti_o      (wb_m2s_ptcB2_cti),
    .wb_ptcB2_bte_o      (wb_m2s_ptcB2_bte),
    .wb_ptcB2_dat_i      (wb_s2m_ptcB2_dat),
    .wb_ptcB2_ack_i      (wb_s2m_ptcB2_ack),
    .wb_ptcB2_err_i      (wb_s2m_ptcB2_err),
    .wb_ptcB2_rty_i      (wb_s2m_ptcB2_rty),
