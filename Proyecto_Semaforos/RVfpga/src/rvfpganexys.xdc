...
# LEDs RGB ejercicio 2 Lab 8:
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { i_led16[0] }]; # R
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { i_led16[1] }]; # G
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { i_led16[2] }]; # B

# LEDs RGB Proyecto Estructuras / LED Tricolor LD17:
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { i_led17[0] }]; # R
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { i_led17[1] }]; # G
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { i_led17[2] }]; # B
