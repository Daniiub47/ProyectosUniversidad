...
#monoaudioout
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { monoaud_pwm }]; # Salida_mono_audio
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { amps_audSD }]; # Enables_amps